  ...
  return (
    <div ref={myRef} className="bg-gradient py-[2rem] bg-cover relative">
      <div className={styles.imagesAll}>
        <div style={{ transform: `translate(0%, ${translateValue}%)` }} className={styles.paralaxBlock}>
          <div className={styles.images}>
            <div className={classNames(styles.first, styles.image)}>
              <div style={{ backgroundImage: `url(data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7)` }}>
      ...
      <div className="_container">
        ...
        <div className="mt-[5rem] text-[#fff] text-[4.4rem] font-medium uppercase leading-[1.2] text-center">
          ...
          <h2 className="flex gap-3 justify-center items-center">
            для запуска сайта
            <span>
              <video muted loop autoPlay playsInline src="https://idaproject.com/video/lite.mp4" className="w-[72px]"></video>
            </span>
            за 1 день
          </h2>
        </div>
